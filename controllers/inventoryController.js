...
export const addProduct = async (req, res) => {
  try {
    ...
    product.image_url = `https://inventory-management-frontend-ocod.onrender.com${product.image_url}`;
...
export const updateProduct = async (req, res) => {
  try {
    ...
    // Add full image URL for response
    updatedProduct.image_url = `https://inventory-management-frontend-ocod.onrender.com${updatedProduct.image_url}`;
